...
class ActualizarEstadiaView extends StatefulWidget {
  final String token;
  ...
  @override
  State<ActualizarEstadiaView> createState() => _ActualizarEstadiaViewState();
}

class _ActualizarEstadiaViewState extends State<ActualizarEstadiaView> {
